      ...
      >
        <path
          class="
            ...
            duration-300
          "
          d="M46.9,-73.1C58,-65.8,62.3,-48.1,60.2,-33.2C58.2,-18.3,49.9,-6.2,51.3,9.8C52.7,25.7,63.9,45.4,61.5,59.7C59,73.9,43,82.8,27.8,80.9C12.7,79,-1.5,66.4,-15.7,59.4C-29.8,52.5,-43.7,51.3,-52.7,44C-61.7,36.7,-65.6,23.3,-62.4,12.1C-59.2,0.8,-49,-8.5,-42.3,-17.7C-35.5,-26.9,-32.4,-36.2,-25.9,-45.6C-19.5,-55,-9.7,-64.6,4.1,-70.9C17.9,-77.3,35.8,-80.4,46.9,-73.1Z"
          transform="translate(100 100)"
        />
      </svg>

      <div class="max-w-4xl mx-auto px-6 md:px-8 z-10">
        <div class="flex flex-col justify-left">
          <h2
            class="
              pt-8
              text-opacity-50 text-xl text-left
              transition
              duration-300
              ease-in-out
              delay-150
          ...
          >
            Hello I'm, <br />
            <span class="font-bold text-5xl"> Yusuf Shehu.</span>
          </h2>

          <h2
            class="
              pt-4
              text-dark_purple-300
          ...
          <p
            ...
            "
          >
            Currently a lead developer @ UBTConsults
        ...
        <p class="mt-3 text-gray-600">
          We recommend you take a look at the <a href="https://nuxtjs.org" target="_blank" class="text-green-500 button--doc hover:underline">Nuxt documentation</a>, whether you are new or have previous experience with the framework.<br>
        </p>
        <p class="pt-4 mt-4 text-gray-800 border-t border-dashed">
          To get started, remove <code class="p-1 text-sm bg-gray-100 border rounded">components/Tutorial.vue</code> and start coding in <code class="p-1 text-sm bg-gray-100 border rounded">pages/index.vue</code>. Have fun!
        </p>
      </div> -->
