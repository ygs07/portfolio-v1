...
<template>
  <div
    class="
      ...
      bg-off-white
      sm:items-center
      dark:bg-rich-black dark:text-off-white
    "
  >
    <link
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      <div class="flex justify-center flex-col">
        ...
        <p
          ...
          "
        >
          I’m a fullstack developer who enjoys vue, laravel and I also have an
        ...
        <div>
          <animated-blob class="absolute top-60 md:left-32"> </animated-blob>
        </div>
      </div>
      ...
      <div class="flex justify-center py-5 space-x-4">
        <nuxt-link
          to="/"
          class="
            transition
            ...
            delay-150
            duration-300
            dark:bg-off-white dark:text-rich-black
            rounded-lg
            py-4
            px-6
          "
